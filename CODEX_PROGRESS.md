...
- Exact next action: commit and push the explicit worker-route denial, monitor Actions, verify the route is 404, manifest remains 200, and private upload endpoints remain 401. Then copy reconciled backlog and progress notes to canonical workspace paths and stop.
